-- 1. Vista de categorías vigentes
CREATE VIEW v_categorias_vigentes AS
SELECT id, nombre, descripcion
FROM   categoria
WHERE  eliminado = FALSE;

-- 2. Vista de productos vigentes con su categoría
...
-- 1. Función para calcular el total del pedido
...
-- 2. Función y Trigger para calcular el subtotal automáticamente
...
-- 3. Función y Triggers para recalcular el total del pedido
...
-- 4. Procedimiento almacenado para crear un pedido con sus detalles de forma transaccional
